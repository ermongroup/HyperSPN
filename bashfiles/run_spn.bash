...
do
    python run.py --run=${runid} --dataset=${dataset}    --batch=500 --N=5 --modeltype=spn --lr=2e-2 --wd=${wd}
done
...
do
    python run.py --run=${runid} --dataset=${dataset}    --batch=50 --N=5 --modeltype=spn --lr=2e-2 --wd=${wd}
done
